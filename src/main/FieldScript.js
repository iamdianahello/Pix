...
for (var i = topPointField; i <= topPointField + fieldHeight; i += onePiece) {
    context.beginPath();    
   	context.strokeStyle = 'red';
   	context.moveTo(leftPointField, i);
   	context.lineTo(leftPointField + fieldWidth, i);
   	context.stroke();
}
...
field.addEventListener(
      'click',
      function(position){definePiecePosition(position.clientX, position.clientY);},
      false);
